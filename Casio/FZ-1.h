...
static_assert(sizeof(FzFileHeader) == 16,
   "Casio FZ-1 FzFileHeader struct should be 16 bytes");
...
static_assert(sizeof(Bank) == 656,
   "Casio FZ-1 Bank struct should be 656 bytes");

struct BankBlock: Block, Bank {
    uint8_t pad_[1024 - sizeof(Bank)] = { 0 };
};
static_assert(sizeof(BankBlock) == 1024,
...
static_assert(sizeof(BankBlockFileHeader) == 1024,
   "Casio FZ-1 BankBlockFileHeader struct should be 1024 bytes");
...
static_assert(sizeof(Voice) == 192,
   "Casio FZ-1 Voice struct should be 192 bytes");

struct VoicePad_: Voice {
    uint8_t pad_[256 - sizeof(Voice)] = { 0 };
};
static_assert(sizeof(VoicePad_) == 256,
   "Casio FZ-1 VoicePad_ struct should be 256 bytes");
...
static_assert(sizeof(VoiceBlock) == 1024,
   "Casio FZ-1 VoiceBlock struct should be 1024 bytes");
...
static_assert(sizeof(VoiceBlockFileHeader) == 1024,
   "Casio FZ-1 VoiceBlockFileHeader struct should be 1024 bytes");
...
static_assert(sizeof(Effect) == 24,
   "Casio FZ-1 Effect struct should be 24 bytes");
...
static_assert(sizeof(EffectBlockFileHeader) == 1024,
   "Casio FZ-1 EffectBlockFileHeader struct should be 1024 bytes");
...
static_assert(sizeof(Wave) == 1024,
   "Casio FZ-1 Wave struct should be 1024 bytes");

struct WaveBlock: Block, Wave {};
static_assert(sizeof(WaveBlock) == 1024,
   "Casio FZ-1 WaveBlock struct should be 1024 bytes");
...
static_assert(sizeof(UnknownBlock) == 1024,
   "Casio FZ-1 UnknownBlock struct should be 1024 bytes");
